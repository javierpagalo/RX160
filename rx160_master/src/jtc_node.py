...
def perform_trajectory():
    ...
    rospy.init_node('staubli_trajectory_publisher') #Node definition
    ...
    staubli_joints = ['joint_1', 'joint_2', 'joint_3', 'joint_4', 'joint_5', 'joint_6'] #Name of joints
    ...
    trajectory_msg.joint_names = staubli_joints

    trajectory_msg.points.append(JointTrajectoryPoint())

    trajectory_msg.points[0].positions = goal_positions

    trajectory_msg.points[0].velocities = [0.0 for i in staubli_joints]

    trajectory_msg.points[0].accelerations = [0.0 for i in staubli_joints]
